...
public class ProfileTestData {
    ...
    public static final ContactTo CONTACT_VK = new ContactTo("vk", "adminVk");
    ...
    public static final Set<ContactTo> ADMIN_CONTACTS = Set.of(CONTACT_GITHUB, CONTACT_TG, CONTACT_VK);
